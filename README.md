...
```bash
deno run -A jsr:@simonneutert/quickblog@0.0.3 build
```
...
deno run -A jsr:@simonneutert/quickblog@0.0.3 new "my new blog post"
```
...
deno run -A jsr:@simonneutert/quickblog@0.0.3 new "My Post" --yaml
```
